...
export default function ErrorMsg () {
  return (
    <div className="py-10 bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 dark:bg-dark min-h-screen">
      <div className="container mx-auto">
        <div className="border-l-yellow-500  dark:bg-dark-2 flex max-w-[655px] items-center rounded-md border-l-[6px] bg-white p-5 pl-6">
          <div className="bg-yellow-500 mr-5 flex h-[36px] w-full max-w-[36px] items-center justify-center rounded-full">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
          ...
          <div className="flex items-center justify-between w-full">
            <div>
              ...
              <p className="text-sm text-gray-500">
                A critical system failure has occurred due to an unexpected issue!
                Please refresh the page, try again later, or contact our support team for immediate assistance.
              </p>
            </div>
            <div>
              <Link href="/" className="duration-300 text-black">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
