...
export default function Home() {
  ...
  if (!session) {
    return (
      <main className="min-h-screen p-6 flex justify-center bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 relative">
        <div className="w-16 h-16 md:w-40 md:h-40" style={{ position: 'absolute', left: '5rem' }}>
          <motion.div
            initial={{ rotate: 0 }}
        ...
        <div className="text-center max-w-6xl">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4 py-16">
              <motion.span
                initial={{ y: -50 }}
                animate={{ y: 0 }}
  ...
  return (
    <main className="p-6 bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 min-h-screen">
      <div className="flex flex-col items-center mb-4 text-center">
        <div className="w-16 h-16 md:w-40 md:h-40 mb-4">
          <motion.div
            initial={{ rotate: 0 }}
            animate={{ rotate: [0, 360, 0] }}
            transition={{ duration: 4, repeat: Infinity, repeatDelay: 1 }}
      ...
      <div className="mb-6 text-center text-lg md:text-xl text-gray-700">
        <motion.p
...
//       >
//         <div className="md:w-28 md:h-28" style={{ position: 'absolute', left: '5rem', width: '3rem', height: '3rem' }}>
//           <motion.div
//             initial={{ rotate: 0 }}
//             animate={{ rotate: [0, 360, 0] }}
//             transition={{ duration: 4, repeat: Infinity, repeatDelay: 1 }}
...
//           ><span className="w-12 h-12 md:w-28 md:h-28"></span>
//             <Image
//               src={logo}
//               alt="Zettabyte Logo"
//               className="w-full h-full object-cover rounded-full shadow-lg"
